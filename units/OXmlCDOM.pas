...
type
  ...
  public
    ...
    function FindAttributeById(const {%H-}aNameId: OHashedStringsIndex; var outAttr: TXMLNode): Boolean; overload; virtual;
    //get attribute
...
begin
  ...
  {$ELSE}
  fIndex.AddPointer(aAttributeNode.NodeNameId, aAttributeNode);
  {$ENDIF}
end;
