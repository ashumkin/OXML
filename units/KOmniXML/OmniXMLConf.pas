...
uses SysUtils, Classes, OmniXML, OmniXML_Types, OmniXMLUtils
...
type TxmlConf=class
  ...
  public
    constructor Create(const FileName: XmlString);
...
constructor TxmlConf.Create(const FileName: XmlString);
begin
...
begin
  ...
  if dirty or shutdown then begin
    FFileStream.Size := 0;
